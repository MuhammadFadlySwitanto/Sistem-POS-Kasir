...
import CnmRoll from './assets/Cinnamonroll.jpg';
import Latte from './assets/how-to-make-a-latte.jpg';
import ClbSandwich from './assets/Club-sandwich-4.jpg';
import EarlTea from './assets/Iced-Earl-Gray-Latte.jpg';
import IcedGrnTea from './assets/matcha-ice-green-tea-.avif';
...
export const PRODUCTS: Product[] = [
  ...
  { id: 3, name: 'Latte', price: 4.75, category: 'Coffee', image: Latte },
  ...
  { id: 7, name: 'Earl Grey', price: 3.25, category: 'Tea', image: EarlTea },
  { id: 8, name: 'Iced Green Tea', price: 3.50, category: 'Tea', image: IcedGrnTea },
  ...
  { id: 12, name: 'Cinnamon Roll', price: 4.00, category: 'Pastries', image: CnmRoll },
  { id: 13, name: 'Bagel', price: 2.75, category: 'Food', image: Bagel },
  { id: 14, name: 'Avocado Toast', price: 6.50, category: 'Food', image: AvoToast },
  { id: 15, name: 'Club Sandwich', price: 7.50, category: 'Food', image: ClbSandwich },
