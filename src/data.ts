...
export const PRODUCTS: Product[] = [
  ...
  { id: 4, name: 'Americano', price: 3.75, category: 'Coffee', image: '' },
  { id: 5, name: 'Chai Latte', price: 4.25, category: 'Tea', image: '' },
  ...
  { id: 10, name: 'Croissant', price: 3.25, category: 'Pastries', image: '' },
  ...
  { id: 13, name: 'Bagel', price: 2.75, category: 'Food', image: '' },
  { id: 14, name: 'Avocado Toast', price: 6.50, category: 'Food', image: '' },
